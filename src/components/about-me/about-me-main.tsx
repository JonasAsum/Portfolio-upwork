...
const AboutMeSection = () => {
  return (
    <div className="px-4 sm:px-6 lg:px-8 pt-64">
      <div>
        <h2 id="about-me-title" className="text-4xl font-bold mb-24">About Me</h2>
      </div>
      <div className="flex justify-end mb-16">
        <div id="about-me-content" className="bg-opacity-50 p-6 max-w-md ml-8 sm:ml-0 rounded-3xl">
          <p className="mb-4">Hi, I'm Jonas, a Full-Stack Developer specializing in React and TailwindCSS.</p>
